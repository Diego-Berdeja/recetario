...
PROPERTIES = [{'Calcium'}, {'Calories'}, {'Carbohydrates'}, {'Cholesterol'}, {'Fibre'}, {'Iron'}, {'Monosaturated Fat'},
              {'Name'}, {'Poly-saturated Fat'}, {'Potassium'}, {'Protein'}, {'Saturated Fat'}, {'Sodium'}, {'Sugar'},
              {'Total Fat'}, {'Vitamin A'}, {'Vitamin B12'}, {'Vitamin B6'}, {'Vitamin C'}, {'Vitamin E'},
              {'Vitamin K'}]
########################################################################################################################
...
class MainWindow(qtw.QMainWindow, Ui_mw_main_window, Ui_dialog_property_editor):
    ...
    def __init__(self):
        ...
        self.recipes = self.load_from_file()
